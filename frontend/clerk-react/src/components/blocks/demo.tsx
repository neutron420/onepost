...
const defaultTiers = [
  {
    ...
    icon: (
      <div className="relative">
        <div className="absolute inset-0 bg-gradient-to-r from-yellow-400/30 to-pink-400/30 blur-2xl rounded-full" />
        <Sparkles className="w-7 h-7 relative z-10 text-yellow-500 animate-[float_3s_ease-in-out_infinite]" />
      </div>
    ),
    features: [
      {
  ...
  },
  {
    ...
    icon: (
      <div className="relative">
        <ArrowDownToDot className="w-7 h-7 relative z-10 text-gray-500 dark:text-gray-400" />
      </div>
    ),
    features: [
      {
