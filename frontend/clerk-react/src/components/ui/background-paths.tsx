...
function FloatingPaths({ position }: { position: number }) {
  const paths = Array.from({ length: 36 }, (_, i) => {
    ...
    const heightStep = i * 8; // Increased height step for more coverage
  ...
  return (
    <div className="absolute inset-0 pointer-events-none">
      <svg
        ...
        viewBox="0 0 800 1200" // Extended viewBox height for full page coverage
        fill="none"
...
// Export additional background component for other sections
